...
assign result = ((ciN == customId) & start) ? counterValue : 32'd0;

// wire enable0 = valueB[0] & ~valueB[4];
// wire enable1 = valueB[1] & ~valueB[5] & stall;
// wire enable2 = valueB[2] & ~valueB[6] & busIdle;
// wire enable3 = valueB[3] & ~valueB[7];
